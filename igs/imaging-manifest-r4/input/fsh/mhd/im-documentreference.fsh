...
* extension contains	http://hl7.org/fhir/5.0/StructureDefinition/extension-DocumentReference.practiceSetting named practiceSetting 0..1
* extension[practiceSetting].valueCodeableConcept 
...
// bodysite
* extension contains http://hl7.org/fhir/5.0/StructureDefinition/extension-DocumentReference.bodySite named bodySite 0..*
* extension[bodySite].extension[concept] 1..1 
* extension[bodySite].extension[concept].valueCodeableConcept 1..1
...
* extension[bodySite].extension[concept].valueCodeableConcept from AnatomicalRegionVs (required)
...
* extension contains 	http://hl7.org/fhir/5.0/StructureDefinition/extension-DocumentReference.modality named modality 1..*
* extension[modality].valueCodeableConcept from https://dicom.nema.org/medical/dicom/current/output/chtml/part16/sect_CID_29.html (required) 
...
//R5Profile: CodeableReferenceWithRequiredCoding
