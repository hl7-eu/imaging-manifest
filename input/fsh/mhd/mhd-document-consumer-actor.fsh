Instance: MhdDocumentResponder
InstanceOf: ActorDefinition
Title: "MHD Document Responder"
...
Usage: #definition
* name = "IHE_EU_MHD_DocumentResponder"
* title = "Document Responser (server)"
* status = #draft
* experimental = false
* publisher = "HL7 Europe"
* description = "The IHE-MHD - Document Responder (server)."
* type = #system
* capabilities[+] = Canonical(MhdDocumentConsumerCapabilityStatement)

Instance: MhdDocumentConsumerCapabilityStatement
...
* name = "IHE_EU_MHD_DocumentConsumerCapabilityStatement"
* title = "Document Consumer Capability Statement"
* status = #draft
* experimental = false
* publisher = "HL7 Europe"
