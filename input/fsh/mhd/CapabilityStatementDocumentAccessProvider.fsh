// CapabilityStatement for EEHRxF Imaging Manifest Document Access Provider Actor
// Composite actor grouping MHD Document Responder + PDQm Supplier + IUA

Instance: EehrxfImagingManifestAccessProvider
InstanceOf: CapabilityStatement
Title: "EEHRxF Imaging Manifest Document Access Provider CapabilityStatement"
Usage: #definition
Description: """
CapabilityStatement for the EEHRxF Imaging Manifest Document Access Provider actor. This composite actor
provides access to EEHRxF FHIR Documents by serving them to Document Consumers via query APIs.

"""

* name = "EEHRxFImagingManifestDocumentAccessProvider"
* title = "EEHRxF Imaging Manifest Document Access Provider CapabilityStatement"
* status = #active
* experimental = false
* date = "2026-01-26"
...
* imports[+] = Canonical( IHE.RAD.MADO.DocumentResponder )

// Server mode for Document Access Provider
* rest[+].mode = #server
* rest[=].documentation = """
The Imaging Manifest Document Access Provider actor responds to document queries from Document Consumers
