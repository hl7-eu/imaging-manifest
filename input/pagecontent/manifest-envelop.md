...
1. **Obligations.** Both [[[EuMadoFhirDocumentReference]]] and [[[EuMadoDicomKosDocumentReference]]] add producer/consumer `Obligations` for the [[[EuMadoImagingManifestProducer]]] and [[[EuMadoImagingManifestConsumer]]] actors on the DocumentReference elements (`identifier`, `type`, `category`, `subject`, `author`, `relatesTo`, `content`, `context`, …).
