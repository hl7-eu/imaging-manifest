Profile: MadoIHEmhdKosReference
...
* relatesTo[fhirReference] 
  ...
  * code = #transforms
  * target only Reference( MadoIHEmhdFhirReference )
...
// {{R4}}    * valueUri = Canonical( MadoBundleManifest )
...
{{R5}}  * profile[hl7eu-imaging-report].valueCanonical = Canonical( MadoManifestBundle )


Profile: MadoIHEmhdFhirReference
{{R4}}Parent: EehrxfMhdDocumentReference
{{R5}}Parent: DocumentReference
Title: "EEHRxF MHD DocumentReference Profile for Imaging Reports"
Description: """
...
* relatesTo[kosReference] 
  ...
  * code = #transforms
  * target only Reference( MadoIHEmhdKosReference )
