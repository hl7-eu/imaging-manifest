...
{{R4}}* extension contains	http://hl7.org/fhir/5.0/StructureDefinition/extension-DocumentReference.practiceSetting named practiceSetting 0..1
{{R4}}* extension[practiceSetting].valueCodeableConcept 
{{R5}}* practiceSetting 0..1 
{{R5}}* practiceSetting 
  from PracticeSettingsVs (extensible)
...
// bodysite
{{R4}}* extension contains http://hl7.org/fhir/5.0/StructureDefinition/extension-DocumentReference.bodySite named bodySite 0..*
{{R4}}* extension[bodySite].extension[concept] 1..1 
{{R4}}* extension[bodySite].extension[concept].valueCodeableConcept 1..1
{{R5}}* bodySite only CodeableReferenceWithRequiredCoding
{{R5}}  * insert SliceElement( #value, concept )
{{R5}}  * ^short = "The concept field is required for all bodySites."
{{R5}}* bodySite.concept 1..1

{{R4}}* extension[bodySite].extension[concept].valueCodeableConcept from AnatomicalRegionVs (required)
{{R5}}* bodySite contains anatomical-region 0..*
{{R5}}* bodySite[anatomical-region] from AnatomicalRegionVs (required)
...
{{R }}* content[kos]
{{R }}  * attachment 1..1
{{R }}    * contentType = #application/dicom
{{R }}    * data 0..1
{{R }}    * url 1..1
{{R4}}//not in R4
{{R5}}  * profile 1..*
{{R5}}    * insert SliceElement( #value, value )
{{R5}}  * profile contains kos-manifest 1..1 
{{R5}}  * profile[kos-manifest]
{{R5}}    * valueCoding = $dcm#113030 // Manifest
...
{{R5}}  * profile 1..*
{{R5}}    * insert SliceElement( #value, value )
{{R5}}  * profile contains fhir-manifest 1..1 
{{R5}}  * profile[fhir-manifest].valueCanonical = Canonical( ImImagingStudyManifest )

{{R4}}* extension contains 	http://hl7.org/fhir/5.0/StructureDefinition/extension-DocumentReference.modality named modality 1..*
{{R4}}* extension[modality].valueCodeableConcept from https://dicom.nema.org/medical/dicom/current/output/chtml/part16/sect_CID_29.html (required) 

{{R5}}* modality 1..* 
{{R5}}* modality from https://dicom.nema.org/medical/dicom/current/output/chtml/part16/sect_CID_29.html (required) 
...
{{R5}}Profile: CodeableReferenceWithRequiredCoding
