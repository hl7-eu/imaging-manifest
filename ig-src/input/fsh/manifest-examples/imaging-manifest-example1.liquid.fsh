...
Usage: #example
{{R }}* identifier[+]
{{R }}  * system = "urn:ietf:rfc:3986"
{{R }}  * value = "ihe:urn:oid:1.2.840.10008.5.1.4.1.1.2"
{{R }}* status = #current
...
{{R }}* type = $loinc#LG51714-0	"US|Finger|Multisection|Laterality:ANY"
{{R }}* category = $xds-class-code#images
{{R }}* subject = Reference( Example1-Patient )
{{R }}* content[fhir]
{{R }}  * attachment[+]
{{R }}    * contentType = #application/fhir+json
{{R }}    * url = "./ImagingStudy/1/$generate-fhir-manifest"
{{R4}}// not in R4
{{R5}}  * profile[fhir-manifest].valueCanonical = Canonical( ImImagingStudyManifest)
