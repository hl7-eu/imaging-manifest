...
| [EHDSImagingReport](StructureDefinition-EHDSImagingReport.html).header.authorSpecialty | CompositionEuImaging.author[author];<br/>DiagnosticReportEuImaging.resultsInterpreter[author] |  |
...
| [EHDSImagingReport](StructureDefinition-EHDSImagingReport.html).[body.examinationReport.adverseReaction](StructureDefinition-EHDSAllergyIntolerance.html) | AdverseEventEuImaging.suspectEntity[procedure];<br/>AdverseEventEuImaging.subjectMedicalHistory[allergy];<br/>AdverseEventEuImaging.actuality;<br/>AdverseEventEuImaging.event;<br/>AdverseEventEuImaging.subject |  |
...
| [EHDSImagingReport](StructureDefinition-EHDSImagingReport.html).body.supportinginformation.devices |  |  |
